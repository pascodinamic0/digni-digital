                ...
                >
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground mt-1">{solution.problem}</p>
                    </div>
                    
                    <div>
                      <span className="font-medium text-primary">Solution:</span>
                      <p className="text-muted-foreground mt-1">{solution.solution}</p>
                    </div>
                    
                    <div>
                      <span className="font-medium text-success">Impact:</span>
                      <p className="text-muted-foreground mt-1">{solution.impact}</p>
                    </div>
                  </div>
                </div>
              );
