...
export const BODIES_PART2: Record<string, BodyBuilder> = {
 ...
 <li>Consistent intro/outro (2 to 5 sec music legal for client)</li>
 ...
 ${pricingSection(job, [
 { name: 'Episode lite', scope: 'Edit + notes', priceHint: '$150 to 300' },
 { name: 'Full assembly', scope: '6 assets', priceHint: '$350 to 700' },
 { name: 'Show partner', scope: 'Weekly episodes', priceHint: '$1.2k to 3k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'SKU batch', scope: '20 SKUs image+copy', priceHint: '$400 to 900' },
 { name: 'Hero refresh', scope: 'Top 10 performers', priceHint: '$250 to 600' },
 { name: 'Store partner', scope: 'Monthly new SKUs', priceHint: '$800 to 2k/mo' },
 ])}
 ${mistakesSection([
 ...
 <p>Hour 0 to 4: intake notes + audience. Hour 4 to 12: arc in doc. Hour 12 to 24: AI draft in ${job.tools[0]}. Hour 24 to 40: human tighten. Hour 40 to 48: client rehearsal Loom.</p>
 ...
 ${pricingSection(job, [
 { name: 'Deck rescue', scope: '≤12 slides, 48h', priceHint: '$400 to 900' },
 { name: 'Sales deck', scope: 'Customer facing story', priceHint: '$600 to 1.5k' },
 { name: 'Fundraise pack', scope: 'Deck + appendix + script', priceHint: '$1.5k to 4k' },
 ])}
 ${mistakesSection([
 'Wall of text slides',
 ...
 ${pricingSection(job, [
 { name: 'Page preflight', scope: 'One URL/copy doc', priceHint: '$150 to 400' },
 { name: 'Campaign pack', scope: 'Email + ads + landing', priceHint: '$500 to 1.2k' },
 { name: 'Retainer', scope: 'All AI copy before publish', priceHint: '$1k to 3k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Issue ghost', scope: '1 weekly write+send', priceHint: '$150 to 350' },
 { name: 'Growth ops', scope: 'Write + tests + segments', priceHint: '$600 to 1.5k/mo' },
 { name: 'Launch', scope: 'Setup + first 4 issues', priceHint: '$800 to 2k' },
 ])}
 ${mistakesSection([
 'No segmentation',
 ...
 ${pricingSection(job, [
 { name: 'Outline', scope: '6 module map', priceHint: '$800 to 2k' },
 { name: 'Full curriculum', scope: 'Lessons + assessments', priceHint: '$2k to 6k' },
 { name: 'Cohort support', scope: 'Facilitator guides', priceHint: '$1k to 3k' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Page pair', scope: 'Up to 800 words + notes', priceHint: '$80 to 200' },
 { name: 'Glossary build', scope: '500 terms', priceHint: '$400 to 900' },
 { name: 'Retainer', scope: 'Ongoing locales', priceHint: '$1k to 4k/mo' },
 ])}
 ${mistakesSection([
 ...
 <ul>
 <li>ATS friendly resume (1 to 2 pages)</li>
 ...
 ${pricingSection(job, [
 { name: 'Resume refresh', scope: '1 role focus', priceHint: '$120 to 250' },
 { name: 'Full package', scope: 'Resume + LinkedIn + templates', priceHint: '$250 to 500' },
 { name: 'Executive', scope: 'Leadership narrative', priceHint: '$500 to 1k' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Per listing', scope: '5 to 8 photos', priceHint: '$150 to 400' },
 { name: 'Rush 24h', scope: '+30% fee', priceHint: 'premium' },
 { name: 'Agent bundle', scope: '10 listings/mo', priceHint: '$1k to 2.5k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Onboarding audit', scope: 'Journey + gaps', priceHint: '$600 to 1.5k' },
 { name: 'Sequence build', scope: 'Emails + help center starter', priceHint: '$1.5k to 4k' },
 { name: 'CX retainer', scope: 'Iterate from ticket data', priceHint: '$1k to 3k/mo' },
 ])}
 ${mistakesSection([
 'Email every feature',
 ...
 ${pricingSection(job, [
 { name: 'One off brief', scope: '3 competitors', priceHint: '$400 to 900' },
 { name: 'Weekly memo', scope: 'Ongoing', priceHint: '$800 to 2k/mo' },
 { name: 'Strategy offsite', scope: 'Deep dive + workshop', priceHint: '$2k to 5k' },
 ])}
 ${mistakesSection([
 'Unverified rumors',
 ...
 ${pricingSection(job, [
 { name: 'OS build', scope: 'Schema + 5 automations', priceHint: '$800 to 2.5k' },
 { name: 'Template kit', scope: 'Niche clone + doc', priceHint: '$300 to 700' },
 { name: 'Admin retainer', scope: 'Tune monthly', priceHint: '$400 to 1k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Hook pack', scope: '5 scripts', priceHint: '$200 to 500' },
 { name: 'Produced set', scope: '5 edited variants', priceHint: '$600 to 1.5k' },
 { name: 'Weekly creative', scope: '10 hooks/wk', priceHint: '$1.5k to 4k/mo' },
 ])}
 ${mistakesSection([
 'Fake testimonials',
