...
export const BODIES_PART1: Record<string, BodyBuilder> = {
 ...
 <h3>Day 1 to 2: Baseline audit</h3>
 ...
 <h3>Day 3 to 4: Controlled variants</h3>
 ...
 <h3>Day 5 to 7: Score, document, deliver</h3>
 ...
 ${pricingSection(job, [
 { name: 'CTR Lab Mini', scope: '3 variants + scorecard, 48h', priceHint: '$75 to 150' },
 { name: 'Channel Refresh', scope: '10 thumbnails + style guide', priceHint: '$400 to 900' },
 { name: 'Monthly Growth', scope: '8 to 12 thumbs + monthly audit', priceHint: '$800 to 2k/mo' },
 ])}
 ${mistakesSection([
 ...
 { q: 'How do I get first clients?', a: 'DM 20 creators with 5k to 50k subs, offer one free lab, show the scorecard.' },
 ])}
 ${promptsSection(job)}
 ...
 <ol>
 <li><strong>0:00 to 0:02, Pattern interrupt</strong>, bold claim, question, or visual jolt. No logos, no “hey guys.”</li>
 <li><strong>0:02 to 0:15, Problem</strong>, one sentence pain; b roll proves it (not wallpaper).</li>
 <li><strong>0:15 to 0:35, Proof</strong>, demo, stat, testimonial, or screen recording.</li>
 <li><strong>0:35 to 0:45, CTA</strong>, one action; on screen text mirrors the spoken line.</li>
 </ol>
 ...
 <p>Start with a 2 to 5 minute talking head or screen recording. Use ${ext('Opus Clip', 'https://www.opus.pro/')} to find hook candidates, then <strong>override</strong> with your map in ${job.tools[0]}. Pull B roll from ${job.tools[1]} or stock; remove filler words in ${job.tools[2]}; color and audio in ${job.tools[4]} if client brand requires it.</p>
 ...
 ${pricingSection(job, [
 { name: 'Short Rescue', scope: '1 clip → 45s + captions, 24h', priceHint: '$80 to 200' },
 { name: 'Weekly Sprint', scope: '4 shorts + maps', priceHint: '$600 to 1.2k/mo' },
 { name: 'Content OS', scope: '12 shorts + template + caption style', priceHint: '$1.5k to 3k/mo' },
 ])}
 ${mistakesSection([
 ...
 { q: 'How fast should turnaround be?', a: '24 to 48h for shorts wins retainers. Batch filming helps.' },
 ...
 <h3>Voice matrix (rate 1 to 5 on each axis)</h3>
 <ul>
 ...
 <li><strong>Humor</strong>, none ↔ light (often 1 to 2 in fintech/health)</li>
 </ul>
 ...
 ${pricingSection(job, [
 { name: 'Voice Kit', scope: 'Matrix + system prompt + 20 tests', priceHint: '$500 to 1.2k' },
 { name: 'Bot MVP', scope: '3 flows + escalate + analytics', priceHint: '$1.5k to 4k' },
 { name: 'Tune & Measure', scope: 'Monthly deflection + CSAT review', priceHint: '$800 to 2k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Polish', scope: 'Up to 1,500 words', priceHint: '$50 to 120' },
 { name: 'Voice + structure', scope: 'Up to 2,500 words + cite pass', priceHint: '$150 to 350' },
 { name: 'Retainer', scope: '4 articles/mo', priceHint: '$800 to 2k/mo' },
 ])}
 ${mistakesSection([
 ...
 <li><strong>FAQ blocks</strong>, 40 to 60 word answers models can quote</li>
 ...
 ${pricingSection(job, [
 { name: 'GEO Snapshot', scope: '90 min audit + 1 page gaps', priceHint: '$300 to 700' },
 { name: 'Citation Sprint', scope: '8 FAQs + 2 proof pages', priceHint: '$1.2k to 3k' },
 { name: 'Monthly monitor', scope: '15 queries + delta report', priceHint: '$500 to 1.5k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Eval audit', scope: 'Review prompts + 25 tests', priceHint: '$800 to 2k' },
 { name: 'Feature hardening', scope: 'One workflow + logging', priceHint: '$2k to 6k' },
 { name: 'Advisory', scope: 'Monthly regression review', priceHint: '$1k to 3k/mo' },
 ])}
 ${mistakesSection([
 ...
 <tr><td style="padding:8px;">3 Enrich</td><td style="padding:8px;">${job.tools[4]} + Claude</td><td style="padding:8px;">Summary + intent 1 to 10</td></tr>
 ...
 ${pricingSection(job, [
 { name: 'Single Kit', scope: 'One automation + docs', priceHint: '$600 to 1.5k' },
 { name: 'Stack audit', scope: 'Map 5 processes, prioritize 2', priceHint: '$400 to 900' },
 { name: 'Care plan', scope: 'Monitor + tweak monthly', priceHint: '$300 to 800/mo' },
 ])}
 ${mistakesSection([
 ...
 <li>Chapter splits every 90 to 120 seconds for long course audio</li>
 </ul>
 ...
 ${pricingSection(job, [
 { name: 'Spot', scope: 'Up to 60s, one voice', priceHint: '$40 to 120' },
 { name: 'Episode', scope: '10 min narrated + mastering', priceHint: '$200 to 500' },
 { name: 'Brand voice', scope: '3 profiles + style guide', priceHint: '$600 to 1.2k' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Brand lock setup', scope: 'Doc + 10 prompts', priceHint: '$500 to 1k' },
 { name: 'Campaign pack', scope: '20 assets + QC', priceHint: '$800 to 2k' },
 { name: 'Monthly refresh', scope: 'Ongoing packs', priceHint: '$1k to 3k/mo' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Discovery + spec', scope: 'Workshop + doc', priceHint: '$1k to 2.5k' },
 { name: 'Agent MVP', scope: 'One JTBD + logging', priceHint: '$3k to 8k' },
 { name: 'Care plan', scope: 'Tune + monitor', priceHint: '$1k to 4k/mo' },
 ])}
 ${mistakesSection([
 ...
 { name: 'Expert reviewer', scope: 'Domain QA', priceHint: '$35 to 55/h' },
 { name: 'Consulting', scope: 'Rubric design for startups', priceHint: '$60 to 100/h' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Per meeting', scope: '&lt;60 min audio', priceHint: '$25 to 60' },
 { name: 'Exec subscription', scope: 'Unlimited* fair use', priceHint: '$300 to 800/mo' },
 { name: 'Team roll out', scope: 'Template + training', priceHint: '$1k to 2k' },
 ])}
 ${mistakesSection([
 ...
 ${pricingSection(job, [
 { name: 'Calendar only', scope: '30 days planned', priceHint: '$200 to 500' },
 { name: 'Calendar + assets', scope: 'Briefs + templates', priceHint: '$600 to 1.2k' },
 { name: 'Full velocity', scope: 'Plan + edit + schedule', priceHint: '$1.5k to 4k/mo' },
 ])}
 ${mistakesSection([
