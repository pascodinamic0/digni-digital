...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  let body: { title?: string; body?: string | null; video_url?: string | null; video_storage_path?: string | null; sort_order?: number }
  try {
  ...
  if (body.video_storage_path !== undefined) updates.video_storage_path = body.video_storage_path
