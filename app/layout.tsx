...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "We believe technology should serve humanity. Digital transformation agency creating real impact.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Digni Digital | Technology That Serves Humanity",
    description:
      "Digital transformation agency creating real impact through technology.",
  },
};
...
export default async function RootLayout({
  ...
  const localeSegment = routing.locales.includes(
