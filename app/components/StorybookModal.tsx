...
const STORY_SLIDES: StorySlide[] = [
  ...
  },
  {
    ...
    content: {
      ...
      fr: 'J\'ai baissé la tête et construit. Chaque expérience de chaque pays, chaque échec, chaque leçon, tout a été réinvesti dans Digni Digital. Des systèmes d\'employés IA qui capturent chaque prospect. Le Programme Diplômé Prêt pour l\'Avenir. Des logiciels agentiques. Toutes les pièces s\'assemblent.',
