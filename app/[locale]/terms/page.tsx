      ...
      <main className="min-h-screen pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-invert prose-sm max-w-none text-muted space-y-6">
            ...
            <p>
              Specific services (e.g. AI Employee, Future-Ready Graduate Program, Agentic Softwares) are subject to separate agreements, statements of work, or terms presented at the time of engagement.
            </p>
