...
export const aiEmployeeProductDemosEn: AiEmployeeProductDemosTranslations = {
  conversations: {
    ...
    subtitle: 'Watch leads go from "just browsing" to booked appointments in under 4 minutes. Every channel. Every time. No human required.',
    liveLabel: 'Live',
...
export const aiEmployeeProductDemosFr: AiEmployeeProductDemosTranslations = {
  ...
  conversations: {
    ...
    subtitle: 'Voyez comment un lead passe de simple curieux à rendez-vous réservé en moins de 4 minutes. Tous les canaux. À chaque fois. Sans intervention humaine.',
    liveLabel: 'En direct',
