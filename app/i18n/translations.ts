...
function buildTranslations(): Record<Language, TranslationKeys> {
  ...
  const commonFr = {
    nav: {
      ...
      aiEmployeeDesc:
        'Systèmes intelligents pour les entreprises de services—prospects, fidélisation, croissance sans chaos.',
  ...
  const commonEs = {
    nav: {
      ...
      aiEmployeeDesc:
        'Sistemas inteligentes para negocios de servicios—leads, retención, escalar sin caos.',
      futureReadyGraduate: 'Future-Ready Graduate Program',
  ...
  const homeEn: HomeTranslations = {
    ...
    whatWeDo: {
      ...
      aiEmployeeApproach:
        'We map human bottlenecks and deploy AI that answers, qualifies, and follows up—so leads don\'t slip and clients stay longer.',
      aiEmployeeOutcome1: 'Keep clients longer',
      aiEmployeeOutcome2: 'Convert more leads',
      aiEmployeeOutcome3: 'Scale with confidence',
      aiEmployeeOutcome4: 'Repeat revenue, not one-off wins',
      aiEmployeePrimaryCta: 'Book Your Growth System Audit',
      aiEmployeeSecondaryCta: 'See How It Works',
  ...
  const homeFr: HomeTranslations = {
    ...
    commitment2026: {
      ...
      title: '100 emplois. 10 000 personnes prêtes pour l’économie des petits boulots.',
      subtitle:
    ...
    whatWeDo: {
      ...
      aiEmployeeApproach:
        'Nous cartographions les goulots d\'étranglement humains et déployons une IA qui répond, qualifie et relance—pour que les prospects ne glissent pas et que les clients restent.',
      aiEmployeeOutcome1: 'Clients fidélisés plus longtemps',
      aiEmployeeOutcome2: 'Plus de prospects convertis',
      aiEmployeeOutcome3: 'Croissance sereine',
      aiEmployeeOutcome4: 'Revenus récurrents, pas des coups d\'un jour',
      aiEmployeePrimaryCta: 'Réserver votre audit Growth System',
      aiEmployeeSecondaryCta: 'Voir comment ça marche',
  ...
  const homeAr: HomeTranslations = {
    ...
    whatWeDo: {
      ...
      aiEmployeeDesc:
        'معظم الفرق لا تحتاج برمجيات أخرى—تحتاج بنية تعمل دونها. نبني أنظمة ذكية لشركات الخدمات التي تريد النمو بلا فوضى.',
      aiEmployeeApproach:
        'نحدد الاختناقات البشرية وننشر ذكاءً يردّ ويؤهّل ويتابع—حتى لا يضيع العملاء وتدوم العلاقات.',
      aiEmployeeOutcome1: 'احتفاظ أطول بالعملاء',
      aiEmployeeOutcome2: 'تحويل المزيد من العملاء المحتملين',
      aiEmployeeOutcome3: 'توسّع بوثوقية',
      aiEmployeeOutcome4: 'إيراد متكرر لا صفقات لمرة واحدة',
      aiEmployeePrimaryCta: 'احجز مراجعة Growth System',
      aiEmployeeSecondaryCta: 'اكتشف كيف يعمل',
      futureReadyTitle: 'Future-Ready Graduate Program',
  ...
  const homeDe: HomeTranslations = {
    ...
    whatWeDo: {
      ...
      aiEmployeeDesc:
        'Die meisten Teams brauchen keine neue Software—sie brauchen Infrastruktur, die ohne sie läuft. Wir bauen intelligente Systeme für Dienstleister, die ohne Chaos wachsen wollen.',
      aiEmployeeApproach:
        'Wir finden menschliche Engpässe und setzen KI ein, die antwortet, qualifiziert und nachfasst—damit Leads nicht verloren gehen und Kunden bleiben.',
      aiEmployeeOutcome1: 'Längere Kundenbeziehungen',
      aiEmployeeOutcome2: 'Mehr Leads konvertieren',
      aiEmployeeOutcome3: 'Skalieren mit Ruhe',
      aiEmployeeOutcome4: 'Wiederkehrende Umsätze statt Einmalgewinnen',
      aiEmployeePrimaryCta: 'Growth-System-Audit buchen',
      aiEmployeeSecondaryCta: 'So funktioniert es',
      futureReadyTitle: 'Future-Ready Graduate Program',
  ...
  const homeEs: HomeTranslations = {
    ...
    whatWeDo: {
      ...
      aiEmployeeDesc:
        'La mayoría de los equipos no necesitan más software—necesitan infraestructura que funcione sin ellos. Construimos sistemas inteligentes para negocios de servicios que quieren crecer sin caos.',
      aiEmployeeApproach:
        'Mapeamos cuellos de botella humanos e implementamos IA que responde, califica y hace seguimiento—para que no se pierdan leads y los clientes se queden.',
      aiEmployeeOutcome1: 'Retener clientes más tiempo',
      aiEmployeeOutcome2: 'Convertir más leads',
      aiEmployeeOutcome3: 'Escalar con confianza',
      aiEmployeeOutcome4: 'Ingresos recurrentes, no ventas sueltas',
      aiEmployeePrimaryCta: 'Reservar su auditoría Growth System',
      aiEmployeeSecondaryCta: 'Ver cómo funciona',
      futureReadyTitle: 'Future-Ready Graduate Program',
  ...
  const aboutEn: AboutTranslations = {
    ...
    promiseQuote:
      'We believe the best future is one where everyone has access to the same technology and skills that used to be reserved for a few. When you work with us, we fight for measurable outcomes—more leads, more revenue, or graduates employers actually hire. If we don’t move those numbers, we haven’t done our job.',
  ...
  const aboutFr: AboutTranslations = {
    ...
    promiseQuote:
      'Nous croyons que le meilleur avenir est celui où chacun accède aux mêmes technologies et compétences qu’on réservait autrement à une minorité. Avec nous, nous visons des résultats mesurables—plus de prospects, plus de revenus, ou des diplômés que les employeurs recrutent vraiment. Si ces indicateurs ne bougent pas, nous n’avons pas fait notre travail.',
    founderName: 'Pascal Digny Djohodo',
