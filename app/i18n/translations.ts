...
function buildTranslations(): Record<Language, TranslationKeys> {
  ...
  const commonFr = {
    ...
    footer: {
      ...
      company: 'Entreprise',
      theme: 'Thème',
      futureReadyDemo: 'Démo Future-Ready Graduate Program',
  ...
  const homeFr: HomeTranslations = {
    ...
    stats: {
      ...
      stat2Sublabel: 'Succès Future-Ready Graduate Program',
  ...
  const blogFr: BlogTranslations = {
    ...
    readyFutureReady: 'Prêt pour le programme Future-Ready Graduate ?',
    readyFutureReadyDesc: 'Découvrez le programme Future-Ready Graduate—transformez les étudiants en professionnels prêts pour l\'emploi. 85% d\'emploi en 6 mois.',
    exploreFutureReady: 'Explorer le programme Future-Ready Graduate',
  ...
  const aboutFr: AboutTranslations = {
    ...
    literacyTitle: 'Programme Future-Ready Graduate',
