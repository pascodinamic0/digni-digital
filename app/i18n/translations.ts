...
function buildTranslations(): Record<Language, TranslationKeys> {
  ...
  const homeEn: HomeTranslations = {
    ...
    mission: {
      ...
      description: 'We dream of a world where everyone is enabled, empowered, and connected to the technology and skills that change lives. We create jobs as a core value—teaching skills that bring out entrepreneurial talents through guided learning personalized to everyone\'s gifts. Every business captures every lead. Every student graduates job-ready.',
  ...
  const homeFr: HomeTranslations = {
    ...
    mission: {
      ...
      description: 'Nous rêvons d\'un monde où chacun est outillé, responsabilisé et connecté aux technologies et compétences qui changent les vies. La création d\'emplois est une valeur centrale—nous enseignons des compétences qui révèlent les talents entrepreneuriaux grâce à un apprentissage guidé personnalisé aux dons de chacun. Chaque entreprise capture chaque prospect. Chaque étudiant obtient un emploi.',
  ...
  const homeAr: HomeTranslations = {
    ...
    mission: {
      ...
      description: 'نحلم بعالم يُمكّن الجميع ويربطهم بالتقنية والمهارات التي تغيّر الحياة. خلق الوظائف قيمة جوهرية—نعلّم مهارات تكشف المواهب الريادية عبر تعلم موجّه شخصي وفق مواهب كل فرد. كل شركة تستقطب كل عميل. كل طالب يتخرج جاهزاً للوظيفة.',
      valuesTitle: 'قيمنا',
