...
function buildTranslations(): Record<Language, TranslationKeys> {
  ...
  const homeEn: HomeTranslations = {
    ...
    mission: {
      ...
      commitmentOneLiner: 'By end of 2026 we\'re committed to creating 10 jobs and training 100 people to use AI professionally in their line of work.',
    ...
    commitment2026: {
      ...
      title: '10 Jobs. 100 People Trained to Use AI Professionally.',
      subtitle:
        'Talent and opportunity should not depend on luck. We are committing to real employment and focused AI training, so more people can earn, compete, and apply intelligence in their field.',
      pillar1Title: '10 jobs created',
      pillar1Desc: 'Roles at Digni or with our partners by end of 2026, stability you can plan around.',
      pillar2Title: '100 trained in professional AI use',
      pillar2Desc:
        'Ready to use AI in their line of work through programs like our Future-Ready Graduate Program.',
  ...
  const homeFr: HomeTranslations = {
    ...
    commitment2026: {
      ...
      title: '10 emplois. 100 personnes formées à utiliser l\'IA professionnellement.',
      subtitle:
        'Le talent et l’opportunité ne devraient pas relever du hasard. Nous nous engageons sur un emploi réel et une formation IA ciblée, pour que plus de personnes puissent gagner leur vie, rivaliser et appliquer l’intelligence dans leur domaine.',
      pillar1Title: '10 emplois créés',
      pillar1Desc:
        'Postes chez Digni ou avec nos partenaires d’ici fin 2026, une stabilité sur laquelle vous pouvez compter.',
      pillar2Title: '100 personnes formées à l’usage professionnel de l’IA',
      pillar2Desc:
        'Prêtes à utiliser l’IA dans leur métier via des programmes comme le Programme Diplômé Prêt pour l’Avenir.',
  ...
  const homeAr: HomeTranslations = {
    ...
    commitment2026: {
      ...
      title: '10 وظائف. 100 شخص مدرب على استخدام الذكاء الاصطناعي باحترافية.',
      subtitle:
        'الموهبة والفرصة لا يجب أن تكونا صدفة. نلتزم بتوظيف حقيقي وتدريب مركز على الذكاء الاصطناعي, حتى يزيد من يستطيع الكسب والمنافسة واستخدام الذكاء في مجاله.',
      pillar1Title: '10 وظائف',
      pillar1Desc: 'أدوار في Digni أو مع شركائنا بحلول نهاية 2026, استقرار يمكنك الاعتماد عليه.',
      pillar2Title: '100 شخص مدرب على الاستخدام المهني للذكاء الاصطناعي',
      pillar2Desc: 'جاهزون لتوظيف الذكاء الاصطناعي في عملهم عبر برامج مثل Future-Ready Graduate.',
  ...
  const homeDe: HomeTranslations = {
    ...
    commitment2026: {
      ...
      title: '10 Jobs. 100 Menschen geschult für den professionellen KI-Einsatz im Beruf.',
      subtitle:
        'Talent und Chancen dürfen nicht vom Glück abhängen. Wir verpflichten uns zu echten Jobs und fokussierter KI-Qualifizierung, damit mehr Menschen verdienen, mithalten und Intelligenz in ihrem Fach anwenden können.',
      pillar1Title: '10 geschaffene Jobs',
      pillar1Desc: 'Rollen bei Digni oder mit Partnern bis Ende 2026, Planbarkeit, auf die Sie sich verlassen können.',
      pillar2Title: '100 geschult für professionellen KI-Einsatz',
      pillar2Desc:
        'Bereit, KI im eigenen Berufsfeld zu nutzen — etwa durch das Future-Ready Graduate Program.',
  ...
  const homeEs: HomeTranslations = {
    ...
    commitment2026: {
      ...
      title: '10 empleos. 100 personas capacitadas para usar la IA profesionalmente.',
      subtitle:
        'El talento y la oportunidad no deberían depender de la suerte. Nos comprometemos con empleo real y formación enfocada en IA, para que más personas puedan ganar, competir y aplicar la inteligencia en su ámbito.',
      pillar1Title: '10 empleos creados',
      pillar1Desc: 'Puestos en Digni o con socios para finales de 2026, estabilidad en la que puede confiar.',
      pillar2Title: '100 capacitados en uso profesional de la IA',
      pillar2Desc:
        'Listos para usar la IA en su línea de trabajo mediante programas como Future-Ready Graduate.',
  ...
  const futureReadyGraduateEs: FutureReadyGraduateTranslations = {
    heroBadge: 'Programa Future-Ready Graduate',
    heroTitleLine1: 'Convierte a tus graduados en',
    heroTitleHighlight: 'profesionales listos para la industria',
    heroAlternateTitle: 'Equipa a profesionales y jóvenes con las habilidades para prosperar mientras la IA transforma el trabajo',
    heroDescription: '85% empleados. La creación de empleo está en nuestro ADN: enseñamos habilidades que despiertan dones emprendedores mediante aprendizaje guiado y personalizado.',
    ...
    educationFails: 'se está quedando atrás',
    digitalEconomyPrefix: 'El trabajo remoto listo para IA ',
    digitalThrives: 'está creciendo',
    educationFailsSubtitle: 'La revolución digital abre oportunidades sin precedentes. Posiciona a tus estudiantes al frente de esta transformación.',
  ...
  const futureReadyGraduateDe: FutureReadyGraduateTranslations = {
    heroBadge: 'Future-Ready Graduate Program',
    heroTitleLine1: 'Machen Sie Ihre Absolventen zu',
    heroTitleHighlight: 'branchenbereiten Fachkräften',
    heroAlternateTitle: 'Statten Sie Fachkräfte und Jugendliche mit den Kompetenzen aus, die sie brauchen, während KI die Arbeitswelt verändert',
    heroDescription: '85% beschäftigt. Jobschaffung liegt in unserer DNA: Wir vermitteln Fähigkeiten, die unternehmerische Begabungen durch personalisiertes, geführtes Lernen freisetzen.',
    ...
    graduationReadyDate: '2.-4. Juli 2026',
    ...
    educationFails: 'fällt zurück',
    digitalEconomyPrefix: 'KI-bereite Remote-Arbeit ',
    digitalThrives: 'wächst',
    educationFailsSubtitle: 'Die digitale Revolution schafft beispiellose Chancen. Positionieren Sie Ihre Studierenden an der Spitze dieser Transformation.',
  ...
  const futureReadyGraduateAr: FutureReadyGraduateTranslations = {
    heroBadge: 'برنامج Future-Ready Graduate',
    heroTitleLine1: 'حوّل خريجيك إلى',
    heroTitleHighlight: 'محترفين جاهزين لسوق العمل',
    heroAlternateTitle: 'زوّد المهنيين والشباب بالمهارات التي يحتاجونها للنجاح بينما يغيّر الذكاء الاصطناعي عالم العمل',
    heroDescription: '85% موظفون. خلق فرص العمل جزء من هويتنا؛ نعلّم مهارات تكشف المواهب الريادية عبر تعلم موجّه ومخصص لكل شخص.',
    ...
    educationFails: 'يتراجع',
    digitalEconomyPrefix: 'العمل عن بعد الجاهز للذكاء الاصطناعي ',
    digitalThrives: 'ينمو',
    educationFailsSubtitle: 'الثورة الرقمية تفتح فرصاً غير مسبوقة. ضع طلابك في مقدمة هذا التحول.',
