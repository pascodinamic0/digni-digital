...
function buildTranslations(): Record<Language, TranslationKeys> {
  ...
  const commonFr = {
    nav: {
      ...
      futureReadyGraduate: 'Future Pre Program',
    ...
    footer: {
      ...
      company: 'Entreprise',
      theme: 'Thème',
      futureReadyDemo: 'Démo Future Pre Program',
  ...
  const homeFr: HomeTranslations = {
    ...
    whatWeDo: {
      ...
      futureReadyTitle: 'Future Pre Program',
    ...
    stats: {
      ...
      stat2Sublabel: 'Succès Future Pre Program',
  ...
  const blogFr: BlogTranslations = {
    ...
    readyFutureReady: 'Prêt pour le programme Future Pre ?',
    readyFutureReadyDesc: 'Découvrez le programme Future Pre—transformez les étudiants en professionnels prêts pour l\'emploi. 85% d\'emploi en 6 mois.',
    exploreFutureReady: 'Explorer le programme Future Pre',
  ...
  const contactFr: ContactTranslations = {
    ...
    projectTypes: [
      ...
      { value: 'future-ready-graduate', label: 'Future Pre Program' },
      { value: 'agentic-softwares', label: 'Agentic Softwares' },
    ],
    methods: [
  ...
  const aboutFr: AboutTranslations = {
    ...
    literacyTitle: 'Programme Future Pre',
