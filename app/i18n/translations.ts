...
newsletterKicker: 'رؤى شهرية',
 ...
 hero: {
  badge: 'Premier Partnerships',
  badge1: 'Premier AI Systems',
  badge2: 'Elite Talent Programs',
  badge3: 'Bespoke Agentic Software',
  title: 'Private Systems. ',
  titleHighlight: 'Elite Outcomes.',
  subtitle:
   'The finest operators don\'t buy off-the-shelf—does your stack reflect that? We deliver premier AI employees, elite talent transformation, and bespoke agentic software for clients who invest at the level they intend to win.',
 stat1Value: '150+',
 ...
 hero: {
  badge: 'Partenariats premium',
  badge1: 'Systèmes IA premium',
  badge2: 'Programmes talent d\'élite',
  badge3: 'Logiciel agentique sur mesure',
  title: 'Systèmes privés. ',
  titleHighlight: 'Résultats d\'élite.',
  subtitle:
   'Les meilleurs opérateurs n\'achètent pas du générique—votre stack en témoigne-t-il ? Nous livrons des employés IA premium, une transformation de carrière d\'élite et un logiciel agentique sur mesure pour les clients qui investissent au niveau où ils comptent gagner.',
 stat1Value: '150+',
 ...
 hero: {
  badge: 'شراكات مميزة',
  badge1: 'أنظمة ذكاء اصطناعي فاخرة',
  badge2: 'برامج مواهب نخبوية',
  badge3: 'برمجيات agentic حسب الطلب',
  title: 'أنظمة خاصة. ',
  titleHighlight: 'نتائج نخبوية.',
  subtitle:
   'أفضل المشغّلين لا يشترون حلولاً جاهزة—هل بنيتك التقنية تعكس ذلك؟ نقدّم موظفين ذكيين فاخرين، وتحولاً مهنياً نخبوياً، وبرمجيات agentic مخصصة للعملاء الذين يستثمرون بالمستوى الذي ينوون الفوز عنده.',
 stat1Value: '+150',
 ...
 hero: {
  badge: 'Premium-Partnerschaften',
  badge1: 'Premium-KI-Systeme',
  badge2: 'Elite-Talentprogramme',
  badge3: 'Maßgeschneiderte Agentic Software',
  title: 'Private Systeme. ',
  titleHighlight: 'Elite-Ergebnisse.',
  subtitle:
   'Die besten Betreiber kaufen kein Standard—spiegelt Ihr Stack das wider? Wir liefern Premium-KI-Mitarbeiter, Elite-Karrieretransformation und maßgeschneiderte Agentic-Software für Kunden, die auf dem Niveau investieren, auf dem sie gewinnen wollen.',
 stat1Value: '150+',
 ...
 hero: {
  badge: 'Alianzas premium',
  badge1: 'Sistemas IA premium',
  badge2: 'Programas de talento élite',
  badge3: 'Software agéntico a medida',
  title: 'Sistemas privados. ',
  titleHighlight: 'Resultados de élite.',
  subtitle:
   'Los mejores operadores no compran genérico—¿su stack lo refleja? Entregamos empleados IA premium, transformación de carrera élite y software agéntico a medida para clientes que invierten al nivel al que pretenden ganar.',
 stat1Value: '150+',
