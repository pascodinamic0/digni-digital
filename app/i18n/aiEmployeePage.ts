...
export const aiEmployeePageEn: AiEmployeePageTranslations = {
  hero: {
    ...
    hook: "Install an AI Employee that answers, qualifies, and books appointments in under 2 seconds — 24/7.\n\nNever miss another call, DM, WhatsApp inquiry, or website lead again.\n\n✓ Respond in under 2 seconds\n✓ Book more qualified appointments\n✓ Recover revenue from existing traffic",
  ...
  denominator: {
    ...
    pillarSpeedHint:
      "Under 2 seconds on every inbound touch. No voicemail lottery.",
    pillarDeploy: "48 hour live deployment",
    pillarDeployHint:
      "We implement, connect channels, and go live, not another tool to babysit.",
    pillarEffort: "Frictionless control",
    pillarEffortHint:
      "Mobile app + automations. You approve; the loop executes.",
  },
  mobileApp: {
    ...
    imageAlt:
      "AI Employee mobile app on a phone showing pipeline metrics and recent activity",
  ...
  caseStudy: {
    ...
    before: {
      ...
      metric: "40%",
      description:
        "Of leads got no timely response. Ad spend kept burning while the pipeline cooled.",
    },
    after: {
      label: "After",
      metric: "100%",
      description:
        "Every inquiry answered fast, with a clear next step, around the clock.",
    },
    contextLabel: "Context",
    challengeLabel: "Challenge",
    solutionLabel: "Solution",
    context:
      "$15k/month in ads, but intake couldn’t keep up with volume or speed.",
    challenge:
      "Roughly 40% of leads weren’t getting a timely response. Pipeline cooled. Revenue leaked.",
    solution:
    ...
    results: [
      {
        metric: "100%",
        description: "Every lead answered, fast, with a consistent next step.",
      },
      {
        metric: "Zero",
        description: "No more “we’ll call them back” gaps in the first mile.",
      },
      {
        metric: "18h",
        description: "From decision to live, so results start immediately.",
      },
      {
        metric: "85%",
        description:
          "Stronger conversion when response time matches buyer urgency.",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "Automated SMS and email reminder sequences when calls go unanswered or appointments slip.",
        value: "$1,500 Value",
      },
      {
        name: "The 5 Star Reputation Engine",
        description:
          "Automated Google and Facebook review collection after successful appointments.",
        value: "$997 Value",
      },
      {
        name: "The CRM Integration Vault",
        description:
          "5,000+ app connectors for zero manual entry data sync across your stack.",
        value: "$500 Value",
      },
    ],
  },
  guarantee: {
    ...
    body: "If we don’t help you generate 15 qualified appointments in 30 days, we continue working for free until you do.",
  },
  scarcity: {
  ...
  pricing: {
    ...
    titleHighlight: "Every Month to Slow Follow-Up?",
    subtitle:
      "In 3 minutes, we’ll calculate:\n\n✓ Revenue leaking from missed leads\n✓ Revenue recoverable with AI\n✓ Whether your business qualifies\n\nIf you qualify, we’ll show you exactly how the AI Employee can transform your pipeline.\n\n15 Qualified Appointments in 30 Days. Guaranteed.",
    assessmentNote:
  ...
  whyDigni: {
    title: "Why Digni Digital?",
    subtitle:
      "Most agencies install software and disappear. We do things differently.",
    intro: [
      "Digni combines AI infrastructure, CRM systems, automation, and business growth strategy into one execution partner.",
      "We don’t just give you tools.",
      "We build a complete revenue engine.",
    ],
    listHeading: "Why businesses choose Digni:",
    items: [
      "Done-for-you implementation",
      "AI + CRM + Growth systems in one",
      "Fast deployment (live in 48 hours)",
      "Strategy + support included",
      "Revenue-focused, not software-focused",
    ],
    footer: [
      "We don’t sell dashboards.",
      "We build systems that generate measurable business growth.",
    ],
  },
  faq: {
    ...
    questions: [
      {
        ...
        a: "No. It removes repetitive follow-up and admin work so your team can focus on closing deals and serving clients.",
      },
      {
        q: "Will the AI sound robotic?",
        a: "No. The AI is customized to your business tone, services, and customer journey.",
      },
      {
        q: "How long does setup take?",
        a: "Most businesses go live within 48 hours.",
      },
      {
        q: "Does this work with our CRM?",
        a: "Yes. We integrate with 5,000+ tools and existing systems.",
      },
      {
        q: "What if we already use software?",
        a: "That’s fine. We integrate with your existing stack or replace inefficient systems.",
      },
      {
        q: "Is this right for every business?",
        a: "No. This works best for high-ticket service businesses that generate leads and sell through appointments or consultations.",
      },
    ],
  },
};
...
export const aiEmployeePageFr: AiEmployeePageTranslations = {
  hero: {
    ...
    titleHighlight:
      "Plus jamais de répondre aux DM, envoyer un lien, ni relancer à la main.",
    hook: "La seule boucle clé en main qui capte, qualifie, réserve, relance et fait monter le panier sur chaque lead payant pendant que vous livrez le service.",
  ...
  dreamOutcome: {
    ...
    subtitle:
      "La fuite conclut ~1 sur 100. La boucle en conclut 95, avec des parrainages qui composent.",
  ...
  denominator: {
    ...
    subtitle:
      "Nous réduisons le délai et l’effort, le système tourne pendant que vous gérez l’entreprise.",
    pillarSpeed: "Réponse instantanée",
    pillarSpeedHint:
      "Moins de 2 secondes sur chaque entrée. Fini la loterie de la messagerie vocale.",
    pillarDeploy: "Déploiement en 48 h",
    pillarDeployHint:
      "Nous implémentons et mettons en ligne, pas un outil de plus à surveiller.",
    pillarEffort: "Pilotage sans friction",
    pillarEffortHint:
      "App mobile + automatisations. Vous validez ; la boucle exécute.",
  },
  mobileApp: {
    title:
      "Voyez chaque lead et répondez depuis votre téléphone, à tout moment.",
    ...
    imageAlt:
      "Application mobile AI Employee sur téléphone avec indicateurs et activité récente",
    appStoreHref: "https://apps.apple.com/",
    playStoreHref: "https://play.google.com/store",
  ...
  caseStudy: {
    ...
    before: {
      ...
      metric: "40 %",
      description:
        "Des leads sans réponse rapide. La pub tournait pendant que le pipeline refroidissait.",
    },
    after: {
      label: "Après",
      metric: "100 %",
      description:
        "Chaque demande traitée vite, avec une prochaine étape claire, 24 h/24.",
    },
    contextLabel: "Contexte",
    challengeLabel: "Défi",
    solutionLabel: "Solution",
    context:
      "15 k$/mois de pub, mais l’intake ne suivait ni le volume ni la vitesse.",
    challenge:
      "Environ 40 % des leads sans réponse rapide. Pipeline tiède. Revenu qui fuit.",
    solution:
    ...
    results: [
      {
        metric: "100 %",
        description:
          "Chaque lead traité vite, avec une prochaine étape claire.",
      },
      {
        metric: "Zéro",
        description:
          "Plus de trous du type « on les rappellera » au début du tunnel.",
      },
      {
        metric: "18 h",
        description:
          "De la décision au live, les résultats commencent tout de suite.",
      },
      {
        metric: "85 %",
        description:
          "Meilleure conversion quand le délai suit l’urgence de l’acheteur.",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "Séquences SMS et email automatiques quand les appels ou RDV passent à la trappe.",
        value: "Valeur 1 500 $",
      },
      {
        name: "Moteur de réputation 5 étoiles",
        description:
          "Collecte automatisée d’avis Google et Facebook après vente réussie.",
        value: "Valeur 997 $",
      },
      {
        name: "Coffre d’intégrations CRM",
        description:
          "5 000+ connecteurs pour une synchro sans saisie manuelle.",
        value: "Valeur 500 $",
      },
    ],
  },
  ...
  pricing: {
    ...
    investmentNote:
      "Les montants s’affichent dans vos résultats, pas sur cette page.",
  ...
  finalCta: {
    ...
    subtitle:
      "Réservez un appel fit de 30 min. Nous cartographions la fuite et validons que la boucle vous convient.",
    primaryCta: "Réserver un appel fit",
  },
  whyDigni: {
    title: "Pourquoi Digni Digital ?",
    subtitle:
      "La plupart des agences installent un logiciel et disparaissent. Nous faisons autrement.",
    intro: [
      "Digni combine infrastructure IA, CRM, automatisation et stratégie de croissance en un seul partenaire d'exécution.",
      "Nous ne vous donnons pas seulement des outils.",
      "Nous construisons un moteur de revenus complet.",
    ],
    listHeading: "Pourquoi les entreprises choisissent Digni :",
    items: [
      "Mise en place clé en main",
      "IA + CRM + systèmes de croissance en un",
      "Déploiement rapide (en ligne en 48 h)",
      "Stratégie + support inclus",
      "Orienté revenus, pas logiciel",
    ],
    footer: [
      "Nous ne vendons pas de tableaux de bord.",
      "Nous construisons des systèmes qui génèrent une croissance mesurable.",
    ],
  },
  faq: {
    ...
    questions: [
      {
        q: "Est-ce que cela remplace mon équipe ?",
        a: "Non. Cela supprime le suivi répétitif et l'administratif pour que votre équipe se concentre sur la conclusion et le service client.",
      },
      {
        q: "L'IA aura-t-elle l'air robotique ?",
        a: "Non. L'IA est personnalisée selon le ton, les services et le parcours client de votre entreprise.",
      },
      {
        q: "Combien de temps dure la mise en place ?",
        a: "La plupart des entreprises sont en ligne sous 48 heures.",
      },
      {
        q: "Est-ce compatible avec notre CRM ?",
        a: "Oui. Nous intégrons plus de 5 000 outils et systèmes existants.",
      },
      {
        q: "Et si nous utilisons déjà des logiciels ?",
        a: "Pas de problème. Nous intégrons votre stack actuel ou remplaçons les systèmes inefficaces.",
      },
      {
        q: "Est-ce adapté à toutes les entreprises ?",
        a: "Non. Cela convient surtout aux entreprises de services à ticket élevé qui génèrent des leads et vendent via rendez-vous ou consultations.",
      },
    ],
  },
};
...
export const aiEmployeePageDe: AiEmployeePageTranslations = {
  hero: {
    ...
    titleHighlight:
      "Nie wieder DMs beantworten, Buchungslinks schicken oder nachfassen.",
    hook: "Der einzige Done for you Loop, der jeden bezahlten Lead erfasst, qualifiziert, bucht, nachfasst und Upsell fährt, während Sie den Service liefern.",
  ...
  dreamOutcome: {
    ...
    subtitle:
      "Das Leck schließt ~1 von 100. Der Loop schließt 95, mit Empfehlungen obendrauf.",
    beforeLabel: "Das Leck",
    beforeMetric: "~1 / 100",
    beforeHint:
      "Abschluss nach manuellem Chaos, Mailbox und langsamen Nachfassen.",
  ...
  denominator: {
    ...
    subtitle:
      "Wir verkürzen Verzögerung und Aufwand, das System läuft, während Sie das Geschäft führen.",
    pillarSpeed: "Sofortige Antwort",
    pillarSpeedHint:
      "Unter 2 Sekunden auf jeden Eingang. Kein Mailbox Glücksspiel.",
    pillarDeploy: "Live in 48 Stunden",
    pillarDeployHint:
      "Wir implementieren und schalten live, kein weiteres Tool zum Hüten.",
    pillarEffort: "Reibungslose Steuerung",
    pillarEffortHint:
      "Mobile App + Automationen. Sie freigeben; der Loop arbeitet.",
  },
  mobileApp: {
    ...
    imageAlt:
      "AI Employee App auf dem Smartphone mit Pipeline Kennzahlen und Aktivität",
    appStoreHref: "https://apps.apple.com/",
    playStoreHref: "https://play.google.com/store",
  ...
  caseStudy: {
    ...
    before: {
      ...
      metric: "40%",
      description:
        "Der Leads ohne zeitnahe Antwort. Werbung lief, während die Pipeline abkühlte.",
    },
    after: {
      label: "Nachher",
      metric: "100%",
      description:
        "Jede Anfrage schnell beantwortet, mit klarem nächsten Schritt, rund um die Uhr.",
    },
    contextLabel: "Kontext",
    challengeLabel: "Herausforderung",
    solutionLabel: "Lösung",
    context:
      "15k$/Monat Werbung, aber die Annahme kam weder mit Volumen noch Tempo nach.",
    challenge:
      "Etwa 40 % der Leads ohne zeitnahe Antwort. Pipeline kühlte. Umsatz floss ab.",
    solution:
    ...
    results: [
      {
        metric: "100%",
        description: "Jeder Lead schnell bedient, mit klarem nächsten Schritt.",
      },
      {
        metric: "Null",
        description: 'Keine „rufen wir zurück" Lücken mehr am Anfang.',
      },
      {
        metric: "18h",
        description: "Von Entscheidung zu live, Ergebnisse starten sofort.",
      },
      {
        metric: "85%",
        description:
          "Bessere Conversion, wenn das Tempo zur Dringlichkeit passt.",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "Automatische SMS und Email Sequenzen bei verpassten Anrufen oder Terminen.",
        value: "Wert 1.500 $",
      },
      {
        name: "5 Sterne Reputation Engine",
        description:
          "Automatische Google und Facebook Bewertungen nach erfolgreichem Abschluss.",
        value: "Wert 997 $",
      },
      {
  ...
  finalCta: {
    ...
    subtitle:
      "Buchen Sie einen 30 Minuten Fit Call. Wir kartieren das Leck und prüfen, ob der Loop passt.",
    primaryCta: "Fit Call buchen",
  },
  whyDigni: {
    title: "Warum Digni Digital?",
    subtitle:
      "Die meisten Agenturen installieren Software und verschwinden. Wir machen es anders.",
    intro: [
      "Digni verbindet KI Infrastruktur, CRM, Automatisierung und Wachstumsstrategie in einem Umsetzungspartner.",
      "Wir geben Ihnen nicht nur Tools.",
      "Wir bauen eine komplette Umsatzmaschine.",
    ],
    listHeading: "Warum Unternehmen Digni wählen:",
    items: [
      "Done for you Implementierung",
      "KI + CRM + Wachstumssysteme in einem",
      "Schnelle Bereitstellung (live in 48 Stunden)",
      "Strategie + Support inklusive",
      "Umsatzorientiert, nicht softwareorientiert",
    ],
    footer: [
      "Wir verkaufen keine Dashboards.",
      "Wir bauen Systeme, die messbares Wachstum erzeugen.",
    ],
  },
  faq: {
    ...
    questions: [
      {
        ...
        a: "Nein. Es übernimmt repetitive Nachverfolgung und Adminarbeit, damit Ihr Team Abschlüsse und Kundenservice fokussieren kann.",
      },
      {
        q: "Klingt die KI roboterhaft?",
        a: "Nein. Die KI wird an Ton, Services und Kundenreise Ihres Unternehmens angepasst.",
      },
      {
        q: "Wie lange dauert die Einrichtung?",
        a: "Die meisten Unternehmen sind innerhalb von 48 Stunden live.",
      },
      {
        q: "Funktioniert das mit unserem CRM?",
        a: "Ja. Wir integrieren über 5.000 Tools und bestehende Systeme.",
      },
      {
        q: "Was, wenn wir bereits Software nutzen?",
        a: "Kein Problem. Wir integrieren Ihren Stack oder ersetzen ineffiziente Systeme.",
      },
      {
        q: "Ist das für jedes Unternehmen geeignet?",
        a: "Nein. Am besten für High Ticket Serviceunternehmen, die Leads generieren und über Termine oder Beratungen verkaufen.",
      },
    ],
  },
};
...
export const aiEmployeePageEs: AiEmployeePageTranslations = {
  hero: {
    ...
    titleHighlight:
      "Nunca más contestar DMs, mandar enlaces de reserva ni perseguir seguimientos.",
    hook: "El único loop llave en mano que captura, califica, agenda, hace upsell y da seguimiento a cada lead pagado mientras tú entregas el servicio.",
  ...
  dreamOutcome: {
    ...
    subtitle:
      "La fuga cierra ~1 de 100. El loop cierra 95, con referidos que componen.",
    beforeLabel: "La fuga",
    beforeMetric: "~1 / 100",
  ...
  denominator: {
    ...
    subtitle:
      "Reducimos retraso y esfuerzo, el sistema corre mientras usted dirige el negocio.",
    pillarSpeed: "Respuesta instantánea",
    pillarSpeedHint:
      "Menos de 2 segundos en cada entrada. Sin lotería del buzón.",
    pillarDeploy: "Despliegue en 48 horas",
    pillarDeployHint:
      "Implementamos y activamos, no otra herramienta que vigilar.",
    pillarEffort: "Control sin fricción",
    pillarEffortHint:
      "App móvil + automatizaciones. Usted aprueba; el loop ejecuta.",
  },
  mobileApp: {
    ...
    imageAlt:
      "App móvil AI Employee en el teléfono con métricas del embudo y actividad reciente",
    appStoreHref: "https://apps.apple.com/",
    playStoreHref: "https://play.google.com/store",
  ...
  caseStudy: {
    ...
    before: {
      ...
      metric: "40%",
      description:
        "De leads sin respuesta a tiempo. Los anuncios seguían mientras el embudo se enfriaba.",
    },
    after: {
      label: "Después",
      metric: "100%",
      description:
        "Cada consulta atendida rápido, con un siguiente paso claro, las 24 horas.",
    },
    contextLabel: "Contexto",
    challengeLabel: "Reto",
    solutionLabel: "Solución",
    context:
      "15k$/mes en anuncios, pero la captación no seguía volumen ni velocidad.",
    challenge:
      "Cerca del 40 % de leads sin respuesta a tiempo. Embudo tibio. Ingreso fugado.",
    solution:
    ...
    results: [
      {
        metric: "100%",
        description: "Cada lead atendido rápido, con siguiente paso claro.",
      },
      {
        metric: "Cero",
        description: "Sin huecos de “los llamamos luego” al inicio.",
      },
      {
        metric: "18h",
        description: "De decisión a en vivo, el impacto empieza ya.",
      },
      {
        metric: "85%",
        description:
          "Mejor conversión cuando el tiempo sigue la urgencia del comprador.",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "Secuencias automáticas de SMS y email cuando no contestan o faltan a citas.",
        value: "Valor 1.500 $",
      },
      {
        name: "Motor de reputación 5 estrellas",
        description:
          "Recolección automática de reseñas en Google y Facebook tras la venta.",
        value: "Valor 997 $",
      },
      {
  ...
  finalCta: {
    ...
    subtitle:
      "Reserve una llamada fit de 30 min. Mapeamos la fuga y confirmamos si el loop encaja.",
    primaryCta: "Reservar llamada fit",
  },
  whyDigni: {
    title: "¿Por qué Digni Digital?",
    subtitle:
      "La mayoría de agencias instalan software y desaparecen. Nosotros hacemos las cosas distinto.",
    intro: [
      "Digni combina infraestructura IA, CRM, automatización y estrategia de crecimiento en un solo socio de ejecución.",
      "No solo le damos herramientas.",
      "Construimos un motor de ingresos completo.",
    ],
    listHeading: "Por qué las empresas eligen Digni:",
    items: [
      "Implementación hecha por nosotros",
      "IA + CRM + sistemas de crecimiento en uno",
      "Despliegue rápido (en vivo en 48 horas)",
      "Estrategia + soporte incluidos",
      "Enfocado en ingresos, no en software",
    ],
    footer: [
      "No vendemos dashboards.",
      "Construimos sistemas que generan crecimiento medible.",
    ],
  },
  faq: {
    ...
    questions: [
      {
        ...
        a: "No. Elimina el seguimiento repetitivo y el trabajo administrativo para que su equipo se enfoque en cerrar y atender clientes.",
      },
      {
        q: "¿La IA sonará robótica?",
        a: "No. La IA se personaliza al tono, servicios y recorrido del cliente de su negocio.",
      },
      {
        q: "¿Cuánto tarda la configuración?",
        a: "La mayoría de empresas están en vivo en 48 horas.",
      },
      {
        q: "¿Funciona con nuestro CRM?",
        a: "Sí. Integramos más de 5.000 herramientas y sistemas existentes.",
      },
      {
        q: "¿Y si ya usamos software?",
        a: "No hay problema. Integramos su stack actual o reemplazamos sistemas ineficientes.",
      },
      {
        q: "¿Es adecuado para todo negocio?",
        a: "No. Funciona mejor para negocios de servicios de ticket alto que generan leads y venden mediante citas o consultas.",
      },
    ],
  },
};
...
export const aiEmployeePageAr: AiEmployeePageTranslations = {
  hero: {
    ...
    titleHighlight:
      "ولن ترد على الرسائل أو ترسل روابط حجز أو تلاحق متابعة يدوياً.",
    hook: "الحلقة الوحيدة الجاهزة التي تلتقط وتؤهل وتحجز وترفع القيمة وتتابع كل عميل مدفوع وأنت تقدّم الخدمة.",
    primaryCta: "ابدأ اختبار الملاءمة (دقيقتان)",
    footnote:
      "15 موعداً مؤهلاً خلال 30 يوماً، أو نعمل مجاناً حتى تحققها. المخاطرة علينا.",
  },
  valueBadges: {
  ...
  caseStudy: {
    ...
    before: {
      ...
      metric: "40٪",
      description:
        "من العملاء المحتملين دون رد آنٍ. الإعلانات استمرت بينما برد المسار.",
    },
    after: {
      label: "بعد",
      metric: "100٪",
      description:
        "كل استفسار يُجاب بسرعة, بخطوة تالية واضحة, على مدار الساعة.",
    },
    contextLabel: "السياق",
    challengeLabel: "التحدي",
    solutionLabel: "الحل",
    context:
      "15 ألف دولار شهرياً إعلانات, لكن الاستقبال لم يواكب الحجم ولا السرعة.",
    challenge:
      "نحو 40٪ من العملاء المحتملين دون رد آنٍ. مسار بارد. إيراد يتسرّب.",
    solution:
    ...
    results: [
      {
        metric: "100٪",
        description: "كل عميل محتمل يُخدم بسرعة, بخطوة تالية واضحة.",
      },
      { metric: "صفر", description: "لا فجوات «سنعاود الاتصال» في البداية." },
      {
        metric: "18س",
        description: "من القرار إلى التشغيل, تبدأ النتائج فوراً.",
      },
      {
        metric: "85٪",
        description: "تحويل أفضل عندما يواكب التوقيت إلحاح المشتري.",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "تسلسلات SMS وبريد تلقائية عند فوات المكالمات أو المواعيد.",
        value: "قيمة 1,500$",
      },
      {
  ...
  finalCta: {
    ...
    subtitle:
      "احجز مكالمة ملاءمة 30 دقيقة. نرسم التسرّب ونؤكد أن الحلقة مناسبة لك.",
    primaryCta: "احجز مكالمة ملاءمة",
  },
  whyDigni: {
    title: "لماذا Digni Digital؟",
    subtitle:
      "معظم الوكالات تثبّت البرمجيات ثم تختفي. نحن نعمل بشكل مختلف.",
    intro: [
      "تجمع Digni بين البنية التحتية للذكاء الاصطناعي وأنظمة CRM والأتمتة واستراتيجية النمو في شريك تنفيذ واحد.",
      "لا نقدّم لك أدوات فقط.",
      "نبني محرك إيرادات متكامل.",
    ],
    listHeading: "لماذا تختار الشركات Digni:",
    items: [
      "تنفيذ جاهز بالكامل",
      "ذكاء اصطناعي + CRM + أنظمة نمو في مكان واحد",
      "نشر سريع (مباشر خلال 48 ساعة)",
      "استراتيجية + دعم مشمولان",
      "مركّز على الإيرادات وليس على البرمجيات",
    ],
    footer: [
      "لا نبيع لوحات تحكم.",
      "نبني أنظمة تولّد نمواً قابلاً للقياس.",
    ],
  },
  faq: {
    ...
    questions: [
      {
        q: "هل سيحل هذا محل فريقي؟",
        a: "لا. يزيل المتابعة المتكررة والعمل الإداري حتى يركّز فريقك على الإغلاق وخدمة العملاء.",
      },
      {
        q: "هل سيبدو الذكاء الاصطناعي آلياً؟",
        a: "لا. يُخصَّص الذكاء الاصطناعي وفق نبرة عملك وخدماتك ورحلة العميل.",
      },
      {
        q: "كم يستغرق الإعداد؟",
        a: "معظم الشركات تصبح جاهزة خلال 48 ساعة.",
      },
      {
        q: "هل يعمل مع CRM لدينا؟",
        a: "نعم. نتكامل مع أكثر من 5000 أداة وأنظمة موجودة.",
      },
      {
        q: "ماذا إذا كنا نستخدم برمجيات بالفعل؟",
        a: "لا مشكلة. نتكامل مع بنيتك الحالية أو نستبدل الأنظمة غير الفعّالة.",
      },
      {
        q: "هل يناسب كل الأعمال؟",
        a: "لا. يناسب بشكل أفضل أعمال الخدمات ذات القيمة العالية التي تولّد leads وتبيع عبر المواعيد أو الاستشارات.",
      },
    ],
  },
};
